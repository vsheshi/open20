...
class Documenti extends \lispa\amos\documenti\models\base\Documenti implements ContentModelInterface, CommentInterface, ViewModelInterface
{
    ...
    public function rules()
    {
        $rules =  ArrayHelper::merge(parent::rules(), [
            ...
            [['documentAttachments'], 'file', 'extensions' => $this->documentsModule->whiteListFilesExtensions,  'checkExtensionByMimeType' => false, 'maxFiles' => 0],
            [['documentMainFile'], 'file', 'skipOnEmpty' => true, 'extensions' => $this->documentsModule->whiteListFilesExtensions, 'checkExtensionByMimeType' => false, 'maxFiles' => 1, 'on' =>  self::SCENARIO_UPDATE],
            [['documentMainFile'], 'file', 'skipOnEmpty' => true, 'extensions' => $this->documentsModule->whiteListFilesExtensions , 'checkExtensionByMimeType' => false, 'maxFiles' => 1, 'on' => self::SCENARIO_CREATE],
        ]);
    ...
    public function deleteNewDocumentVersion()
    {
        ...
        $ok = $this->deleteThisDocumentMainFileRow();
        if ($ok) {
