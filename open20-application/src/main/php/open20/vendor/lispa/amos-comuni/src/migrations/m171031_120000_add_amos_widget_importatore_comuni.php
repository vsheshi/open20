...
class m171031_120000_add_amos_widget_importatore_comuni extends AmosMigrationWidgets
{
    ...
    protected function initWidgetsConfs()
    {
        $this->widgets = [
            [
                'classname' => \lispa\amos\comuni\widgets\icons\WidgetIconImportatoreComuni::className(),
                'type' => AmosWidgets::TYPE_ICON,
                'module' => self::MODULE_NAME,
                //the widget is visible ONLY for second level dashboard 'comuni'
                'dashboard_visible' => 0,
                'child_of' => \lispa\amos\comuni\widgets\icons\WidgetIconImportatoreComuni::className(),
            ]
        ];
    }
}