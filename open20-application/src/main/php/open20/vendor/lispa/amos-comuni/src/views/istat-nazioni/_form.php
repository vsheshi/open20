...
<div class="istat-nazioni-form col-xs-12 nop">
    ...
    <div class="col-lg-6 col-sm-6">
        ...
        <?= $form->field($model, 'nome_inglese')->textInput(['maxlength' => true]) ?>
    </div>
    ...
    <div class="col-lg-6 col-sm-6">
        ...
        <?= $form->field($model, 'unione_europea')->textInput() ?>
    </div>

    <div class="col-lg-6 col-sm-6">

        <?= // generated by schmunk42\giiant\generators\crud\providers\RelationProvider::activeField
        $form->field($model, 'istat_continenti_id')->dropDownList(
            \yii\helpers\ArrayHelper::map(lispa\amos\comuni\models\IstatContinenti::find()->all(), 'id', 'id'),
            ['prompt' => 'Select']
        ); ?>
    </div>
