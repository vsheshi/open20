...
<div class="istat-unione-dei-comuni-form col-xs-12 nop">
    ...
    <div class="col-lg-6 col-sm-6">
        ...
        <?= $form->field($model, 'sito')->textInput(['maxlength' => true]) ?>
    </div>
    ...
    <div class="col-lg-6 col-sm-6">
        ...
        $form->field($model, 'istat_province_id')->dropDownList(
            \yii\helpers\ArrayHelper::map(lispa\amos\comuni\models\IstatProvince::find()->all(), 'id', 'id'),
            ['prompt' => 'Select']
        ); ?>
    </div>
