...
class AmosMigrationWidgets extends Migration
{
    ...
    {
        $oldWidgets = AmosWidgets::findAll(['classname' => $classname]);
    ...
    {
        $widgetToUpdate = AmosWidgets::findOne(['classname' => $widgetData['classname']]);
    ...
    public function safeDown()
    {
        ...
        if ($allOk) {
            ...
            foreach ($this->widgets as $singleWidget) {
                ...
                $this->delete(AmosWidgets::tableName(), ['like', 'classname', $singleWidget['classname']]);
            }
            if ($this->db->driverName === 'mysql') {
