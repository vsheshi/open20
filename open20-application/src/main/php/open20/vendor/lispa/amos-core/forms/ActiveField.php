...
class ActiveField extends YiiActiveField
{
    ...
    public function checkboxList($items, $options = [])
    {
        if ($this->inline) {
            ...
            $options['item'] = function ($index, $label, $name, $checked, $value) use ($itemOptions) {
                ...
                return '<div class="checkbox"><label class="no-asterisk" for="' . $name . $value . '">' . Html::checkbox($name, $checked, $options) . ucwords($label) . '</label></div>';
            };
        }
    ...
    public function radioList($items, $options = [])
    {
        if ($this->inline) {
            ...
            $options['item'] = function ($index, $label, $name, $checked, $value) use ($itemOptions) {
                $options = array_merge(['value' => $value, 'id' => $name . $value, 'name' => $name], $itemOptions);
                return '<div class="radio"><label for="' . $name . $value . '">' . Html::radio($name, $checked, $options) . ucwords($label) . '</label></div>';
            };
        }
