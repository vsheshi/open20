...
class m170220_081455_widget_email_manager extends Migration
{
    ...
    private function setPermissionConfs()
    {
        $this->perms = array(
            ...
            array(
                'name' => \lispa\amos\emailmanager\widgets\icons\WidgetIconEmailManager::className(),
                'type' => '2',
    ...
    public function safeUp()
    {
        ...
        $this->batchInsert('{{%auth_item_child}}',['parent', 'child'], [
            ['ADMIN', \lispa\amos\emailmanager\widgets\icons\WidgetIconEmailManager::className()],
        ]);
        ...
        $this->batchInsert('{{%amos_widgets}}',['classname', 'type', 'module', 'status', 'child_of', 'created_by', 'created_at', 'updated_by', 'updated_at'], [
            [
                \lispa\amos\emailmanager\widgets\icons\WidgetIconEmailManager::className(),
                'ICON',
                $module,
                $status,
                null,
