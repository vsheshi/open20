...
return [
    ...
    '#registation_notification_mail_title' => 'Registration notify',
    '#registration_rejected_mail_title' => 'Registration rejected',
    '#registration_request_mail_title' => 'Registration request',
    ...
    '#msg_header_index_WorkingSubAreas' => 'Welcome {user}, these are the rooms in which you have been invited to participate, the Rooms are shared workspaces in which you can interact with other users and optimize the work of your team. <br> Click on Sign in to enter the Room',
    '#name' => 'Name',
