...
class Documenti extends NotifyRecord
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            [ $required, 'required'],
            [['inviaNotifiche'],'required', 'requiredValue' => 1, 'message' => AmosDocumenti::t('amosdocumenti', 'Conferma invio email destinatari obbligatoria')]
        ];
    }
    ...
    public function attributeLabels()
    {
        return ArrayHelper::merge(parent::attributeLabels(), [
            ...
            'inviaNotifiche' => AmosDocumenti::t('amosdocumenti', 'Confermo di aver selezionato i destinatari a cui arriverà la notifica per questo documento'),
