...
class ManifestSerializer {
    ...
    public function serializeToString(Manifest $manifest) {
        ...
        $this->addCopyleft($manifest->getCopyleftInformation());
    ...
    private function addCopyleft(CopyleftInformation $copyleftInformation) {
        $this->xmlWriter->startElement('copyleft');

        foreach($copyleftInformation->getAuthors() as $author) {
        ...
        $proscription = $copyleftInformation->getProscription();

        $this->xmlWriter->startElement('proscription');
        $this->xmlWriter->writeAttribute('type', $proscription->getName());
        $this->xmlWriter->writeAttribute('url', $proscription->getUrl());
        $this->xmlWriter->endElement();
