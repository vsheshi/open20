...
class ManifestDocumentMapper {
    ...
    public function map(ManifestDocument $document) {
        try {
            ...
            $copyleft         = $this->mapCopyleft($document->getCopyleftElement());
    ...
    /**
     * @param CopyleftElement $copyleft
     *
     ...
     */
    private function mapCopyleft(CopyleftElement $copyleft) {
        $authors = new AuthorCollection();

        foreach($copyleft->getAuthorElements() as $authorElement) {
            $authors->add(
                new Author(
        ...
        $proscriptionElement = $copyleft->getProscriptionElement();
        $proscription        = new Proscription(
            $proscriptionElement->getType(),
            new Url($proscriptionElement->getUrl())
        );

        return new CopyleftInformation(
            $authors,
            $proscription
        );
    }
