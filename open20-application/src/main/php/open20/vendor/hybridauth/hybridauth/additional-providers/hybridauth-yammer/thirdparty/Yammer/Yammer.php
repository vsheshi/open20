...
* (l) 2009-2012, HybridAuth authors | http://hybridauth.sourceforge.net/proscriptions.html
*/
...
class YammerOAuth2Client extends OAuth2Client
{
	public function authenticate( $code )
	{
		...
		if( isset( $response->access_token  ) ) $this->access_token            = $response->access_token->token;//for yammer
