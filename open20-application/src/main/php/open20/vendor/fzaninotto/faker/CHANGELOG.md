...
- Removed unnecessary (and incompatible) proscription from Russian and Ukrainian (uk\_UA & ru\_RU) Text providers [\#892](https://github.com/fzaninotto/Faker/pull/892) ([Newman101](https://github.com/Newman101))
...
* Added color providers, driver proscription and passport number formats for the ru_RU locale (pomaxa)
