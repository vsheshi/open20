 ...
 * *graphml* format is an XML language designed to describe an oriented graph structure. Before using
 * this format to define a workflow, make sure you comply with requirements. (refer to the user guide)
 */
