...
/**
 * This class provides workflow objects (Workflow, Status, Transitions) to the *SimpleWorkflowBehavior* behavior.
...
class WorkflowFileSource extends Object implements IWorkflowSource
{
	 ...
	 * If this status was never loaded before, it is loaded now and stored (cached) for later use.
	 *
	 ...
	 * The workflow definition array format is the one used internally by this class, and that should
