...
class IpValidator extends Validator
{
    ...
    public $ipv4 = true;
    /**
     * @var bool whether the address can be an IP with CIDR subnet, like `IPVALIDATOR_PRIVATE_IPADDRESS5/24`.
    ...
    /**
     * Expands an IPv6 address to it's full notation. For example `IPVALIDATOR_DOCUMENTATION_IPADDRESS31` will be
