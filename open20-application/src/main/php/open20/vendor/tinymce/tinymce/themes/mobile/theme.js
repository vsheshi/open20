...
var mobile = (function () {
  ...
  var substitute = function (owner, detail, compSpec, placeholders) {
    ...
    return base.fold(function (req, valueThunk) {
      ...
      var substituted = $_1r8n3awsje5nvfcd.bind(childSpecs, function (l) {
  ...
  var substituteAll = function (owner, detail, components, placeholders) {
    return $_1r8n3awsje5nvfcd.bind(components, function (l) {
      return substitute(owner, detail, c, placeholders);
    });
  };
  ...
  var concat = function (chain, aspect) {
    var values = $_1r8n3awsje5nvfcd.bind(chain, function (l) {
  ...
  var missingOrderError = function (eventName, tuples) {
    return Result.error(['The event (' + eventName + ') has more than one behaviour that listens to it.\nWhen this occurs, you must ' + 'specify an event ordering for the behaviours in your spec (e.g. [ "listing", "toggling" ]).\nThe behaviours that ' + 'can trigger it are: ' + $_74gpplydje5nvfir.stringify($_1r8n3awsje5nvfcd.map(tuples, function (l) {
        return c.name();
      }), null, 2)]);
  };
  ...
  var takeover = function (root) {
    ...
    var systemApi = SystemApi({
      ...
      removeFromGui: function (l) {
        remove(l);
      },
      addToWorld: function (l) {
        addToWorld(l);
      },
      removeFromWorld: function (l) {
        removeFromWorld(l);
      },
